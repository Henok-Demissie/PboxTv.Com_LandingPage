...
export function SiteFooter() {
  return (
    <footer className="border-t bg-background/80 backdrop-blur-lg">
      <div className="container px-6 md:px-8 lg:px-12 flex flex-col gap-10 py-16">
        <div className="flex flex-col gap-10 md:flex-row">
          <div className="flex flex-1 flex-col gap-4">
            <Link href="/" className="flex items-center gap-2">
              <Icons.logo className="h-6 w-6" />
              <span className="[font-family:var(--font-heading)] text-xl tracking-tight">PboxTv</span>
            </Link>
            <p className="text-muted-foreground max-w-sm opacity-70">
              Stream blockbuster movies, hit series, and live channels in 4K HDR with Dolby Atmos. Download for offline
              and watch anywhere.
            </p>
          ...
          <div className="grid flex-1 grid-cols-2 gap-10 sm:grid-cols-3">
            <div className="flex flex-col gap-2">
              <h3 className="text-sm font-medium tracking-tight">PboxTv</h3>
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-muted-foreground opacity-70">
            &copy; {new Date().getFullYear()} PboxTv. All rights reserved.
          </p>
          <div className="flex gap-4">
            <Link
              href="#terms"
