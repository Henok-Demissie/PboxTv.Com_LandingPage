        ...
        <ScrollReveal>
          <div className="flex flex-col items-center justify-center space-y-6 text-center">
            <div className="space-y-4">
              <AnimatedText
                text="Ready to Stream on PboxTv?"
                variant="heading"
                className="text-3xl [font-family:var(--font-heading)] font-bold tracking-tighter sm:text-5xl gradient-text"
                animation="wave"
              />
              <AnimatedText
                text="Join free and start watching movies, series, and live channels across your devices."
                variant="paragraph"
            ...
            >
              ...
              >
                <OutlineButton size="lg" className="bg-background w-full h-full border-0 px-8 py-3" asChild>
                  <Link href="#movies">Browse Collections</Link>
                </OutlineButton>
              </AnimatedGradientBorder>
            </motion.div>
          </div>
